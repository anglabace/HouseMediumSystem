...
<link href="./css/contractInfo.css" type="text/css" rel="stylesheet" />
<body>
	<div>合同信息</div>
	<hr>
	<div class="baseInfo">
		<div class="ower">
			<table>
				...
				<tr>
					<td>售价:</td>
					<td><input type="text" disabled="false" value="${house.total_price/10000}"></td>
					<td>&nbsp;万元</td>
					<td>&nbsp;&nbsp;面积：</td>
				...
				<tr>
					<td>成交价：</td>
					<td><input type="text" disabled="false" value="${contract.bid}"></td>
					<td>&nbsp;万元</td>
					<td>&nbsp;&nbsp;卖方手机:</td>
